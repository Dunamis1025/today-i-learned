...
# will inherit from these base classes to extend functionality.
#
...
class Unit:
    def __init__(self, name, hp, speed):
        ...
        - Initializes the unit's most basic attributes
        """

        # self refers to the current instance being created
        # Values stored in self are unique to each unit object
        self.name = name      # Unit name
        self.hp = hp          # Health points (HP)
    ...
    def move(self, location):
        """
        Moves the unit toward a specific direction.
    ...
    def damaged(self, damage):
        ...
        If HP drops to 0 or below, the unit is destroyed.
        """
...
class AttackUnit(Unit):
    ...
    def attack(self, location):
        """
        Attacks enemies toward a specific direction.
        """
...
class Marine(AttackUnit):
    def __init__(self):
        # Marines always have fixed base stats
        super().__init__("Marine", 40, 1, 5)

    def stimpack(self):
        """
        Stimpack ability:
        - Conceptually boosts combat performance
...
# - Method overriding
# - Separation of ground and air movement
# ==================================================

class Flyable:
    def __init__(self, flying_speed):
        # Flying speed is stored as an instance variable
        # because each flying unit may differ
        self.flying_speed = flying_speed

    def fly(self, name, location):
        """
        Moves the unit by flying.
        """
...
class FlyableAttackUnit(AttackUnit, Flyable):
    def __init__(self, name, hp, damage, flying_speed):
        """
        A unit that can both attack and fly.
...
def game_over():
    ...
    """
    print("\nPlayer : gg")
    print("[NOTICE] The game has ended.")
...
# Manage all attack units in a single list
...
for unit in attack_units:
    ...
    # Checks whether the object is an instance of the given class
