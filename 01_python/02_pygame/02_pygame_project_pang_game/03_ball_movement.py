...
image_path = os.path.join(current_path, "images")  # Get the images folder path
...
balls.append({
    ...
    "to_x": 3,            # Horizontal direction (-3: left, 3: right)
    "to_y": -6,           # Vertical direction
    "init_spd_y": ball_speed_y[0]  # Initial vertical speed
})
...
while running:
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        # Change direction when the ball hits the side walls (bounce effect)
